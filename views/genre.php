  ...
  <section>
    <div class="container-fluid  mb-0 p-0">
      <div class="container m-auto p-5">
        ...
        <div class="row m-0">
          <!-- Action -->
          <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 w-100" id="bg-1" style="padding-bottom:20px;">
            <div class="hoverfx">
          ...
          <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12" style="padding-bottom:20px;">
            <div class="hoverfx">
              ...
              <div class="textbgbox">
                <h3 class="maginbottom">COMEDIE DRAMATIQUE</h3>
              </div>
            </div>
          </div>
          <!--  COMEDIE MUSICALE-->
          <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12" style="padding-bottom:20px;">
            <div class="hoverfx">
              ...
              <div class="textbgbox">
                <h3 class="maginbottom">COMEDIE MUSICALE</h3>
              </div>
            </div>
          </div>
          <!-- COMEDIE POLICIER-->
          <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12" style="padding-bottom:20px;">
            <div class="hoverfx">
              ...
              <div class="textbgbox">
                <h3 class="maginbottom">COMEDIE POLICIER</h3>
              </div>
            </div>
          </div>
          <!-- COMEDIE ROMANTIQUE -->
